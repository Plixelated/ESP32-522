...
void app_main(void)
{
    ...
    io_conf.pin_bit_mask = (1ULL<<GPIO_NUM_2) | (1ULL<<GPIO_NUM_15)
    | (1ULL<<GPIO_NUM_14)  | (1ULL<<GPIO_NUM_33);
    ...
    while(1){
        ...
        //desired_delay = knob_position/2;

        //LED OFF
        //Sets GPIO PIN 2 to HIGH(1)
        //gpio_set_level(GPIO_NUM_2,1);
        //Sets GPIO PIN 15 to LOW(0)
